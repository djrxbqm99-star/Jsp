...
<!DOCTYPE html>
	...
	<body>
		...
		GET요청
		- 기본 링크 페이지 요청
		- 데이터 전송은 주소 뒤에 ? 파라미터 문자열로(쿼리스트링)로 전송
		- 보안에 취약하지만 빠른 요청 처리 
		...
		<a href="./proc/result4.jsp?userid=a101&name=홍길동&age=21">result4</a> <!-- 주소뒤 ? 파라미터(쿼리스트링) 전송 -->
		
		<form action="./proc/result3.jsp" method ="post"> <!-- form method 속성이 없으면 get 요청-->
